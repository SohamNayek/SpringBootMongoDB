...
public class BookingController {
	 ...
	 */
	@PutMapping("/update")
	public Map<String, Object> update(@RequestParam String bookingId, @RequestBody Booking bookingObj) {
		Booking booking = bookingRepository.findOne(bookingId);
		booking.setPsngrName(bookingObj.getPsngrName());
		booking.setDeparture(bookingObj.getDeparture());
		booking.setDestination(bookingObj.getDestination());
		booking = bookingRepository.save(booking);
		Map<String, Object> dataMap = new HashMap<String, Object>();
